...
@include('admin._partials.bredcum',['title'=>'Brands'] )
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    @include('admin.components.settings.brand-nav-header' ,['activeTab' => 'list'])
                    <div class="card-body">
...
<div class="modal fade" id="add-brands" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" >
            <form id="add-brands-form"  action="{{ route('save-brands')}}" method="post"  enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
...
<div class="modal fade" id="edit-brands" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="edit-brands-form"  action="{{ route('save-brands')}}" method="post"  enctype="multipart/form-data">
                @csrf
